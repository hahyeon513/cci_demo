...
def main(data_path, output_path):
    GCT = GrangerCausalityTest(f'{data_path}/dataset_target_cleaned.csv', 
                                f'{data_path}/dataset_factors_cleaned_reset.csv',
                                f'{data_path}/factor_table.csv',
                                k=15,
                                signif=0.05)
    ...
    GCT.save_significant_vars_dict(output_path)
    GCT.save_significant_vars_dict_kor(output_path)
